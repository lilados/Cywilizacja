...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="header">
            <h1><b>Symulator cywilizacji IN-DEV</b></h1>
        </div>
        <div id="raport" style="position:absolute;width:600px;height:80px;z-index:30;right:30px;top:40px;font-size:16pt;justify-content: center; align-items: center;display: flex;">
            POTRZEBA KAMINIA PANIE!
        </div>
